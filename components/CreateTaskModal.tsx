...
import { ArrowLeft, Plus, Zap, Hash, FileText, Rocket } from 'lucide-react-native';
...
export default function CreateTaskModal({ visible, onClose, onTaskCreated }: CreateTaskModalProps) {
  const { user } = useAuth();
        ...
        <View style={styles.abstractContainer}>
          ...
          >
            <LinearGradient colors={["#00d4ff", "#0099cc"]} style={styles.shapeGradient1}>
              <Hash size={16} color="rgba(255,255,255,0.3)" />
            </LinearGradient>
          </Animated.View>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Text style={styles.welcomeTitle}>Launch Your Next Goal</Text>
                    <Text style={styles.welcomeSubtitle}>
                      Turn your ideas into action. Every breakthrough starts with a clear intention and a simple step forward.
                    </Text>
                  </LinearGradient>
                </Animated.View>
                    ...
                    <View style={styles.inputGroup}>
                      ...
                      <View style={[styles.inputContainer, styles.textAreaContainer]}>
                        <TextInput
                          ...
                          placeholder="Add context, steps, or any details that will help you succeed..."
                          placeholderTextColor="#64748b"
                          value={description}
